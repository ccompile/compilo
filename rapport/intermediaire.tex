...
Nous avons fait le choix d'utiliser deux types d'arbres aux différents stades de la compilation :
\begin{itemize}
    \item Un arbre de syntaxe abstraite étiqueté par la position des expressions dans le source initial
    \item Un arbre sémantique étiqueté par les types de chaque expression (pour les nœuds où cette information est utile dans la phase de production de code)
\end{itemize}
